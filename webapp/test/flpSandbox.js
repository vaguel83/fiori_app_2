					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori app connected to service sflight",
									"targetURL": "#fioriapp2-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"fioriapp2-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fioriapp2",
									"url": sap.ui.require.toUrl("fioriapp2")
								}
							}
						}
					}
